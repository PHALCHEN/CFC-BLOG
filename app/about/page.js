          ...
          <div class="grid md:grid-cols-3 sm:grid-cols-2 gap-8 max-sm:justify-center text-center">
            <div class="bg-white rounded-lg p-6 shadow-md hover:scale-105 transition-all duration-500">
              <div class="lg:min-h-[250px]">
                <img
                  src="\photo_2024-10-29_22-31-17.jpg"
                  class="w-full rounded-lg inline-block"
                />
              </div>

              <div class="mt-6">
                <h4 class="text-gray-800 text-lg font-bold">CHITA</h4>
            ...
            <div class="bg-white rounded-lg p-6 shadow-md hover:scale-105 transition-all duration-500">
              <div class="lg:min-h-[250px]">
                <img
                  src="\photo_2024-10-30_00-17-29.jpg"
                  class="w-full rounded-lg inline-block"
                />
              </div>

              <div class="mt-6">
                <h4 class="text-gray-800 text-lg font-bold">CHEN</h4>
                <p class="text-sm text-gray-600 mt-1">Software Engineer</p>
            ...
            <div class="bg-white rounded-lg p-6 shadow-md hover:scale-105 transition-all duration-500">
              <div class="lg:min-h-[250px]">
                <img
                  src="\photo_2024-10-29_22-33-13.jpg"
                  class="w-full rounded-lg inline-block"
                />
              </div>

              <div class="mt-6">
                <h4 class="text-gray-800 text-lg font-bold">HENG</h4>
