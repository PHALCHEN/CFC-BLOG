...
const page = () => {
  return (
    <div>
      <div class="bg-white font-[sans-serif] min-h-screen flex flex-col items-center justify-center py-6 px-4">
            ...
            <div class="flex flex-wrap items-center justify-between gap-4 !mt-4">
              <div class="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  class="h-4 w-4 shrink-0 text-blue-600 focus:ring-blue-500 border-transparent rounded-md"
                />
                <label
                  for="remember-me"
              ...
              <div>
                <a
                  ...
                  class="text-sm font-semibold text-[#1E2772] hover:underline"
                >
                  Forgot Password?
                </a>
              </div>
            ...
            <div class="!mt-12">
              ...
              <p class="text-sm mt-6 text-center text-gray-800">
                ...
                <a
                  ...
                  class="text-[#1E2772] font-semibold hover:underline ml-1 whitespace-nowrap"
                >
                  Register here
                </a>
              </p>
